...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\********\\Desktop\\********\\19_Databases\\Music\\" + DB_NAME; //C:\Users\********\Desktop\*********\19_Databases\Music
    ...
    // SELECT * FROM albums WHERE artist = ? ORDER BY name COLLATE NOCASE (Prepared statement will insert id at the ? sign)
    ...
    //------------------------------------------------------------------------------------------------------------------
    private static Datasource instance = new Datasource(); //Making it thread save
    //Private constructor for a singleton Class. One instance for multiple controllers to use so that the different
    // controllers operate on the same instance and instance state
    private Datasource() {

    }

    // Datasource.getInstance().methodName(); is how you call the methods in this singleton class
    ...
    public boolean open() {
        try {
            ...
            insertIntoAlbums = conn.prepareStatement(INSERT_ARTIST, Statement.RETURN_GENERATED_KEYS);
    ...
    public void close() {
        try {
            ...
            if(QUERY_ALBUMS_BY_ARTIST_ID != null) {
